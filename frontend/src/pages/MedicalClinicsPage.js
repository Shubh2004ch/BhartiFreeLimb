    ...
    >
      <Container maxWidth="lg">
        ...
        <Box textAlign="center" mb={6}>
          <LocalHospital sx={{ fontSize: 46, color: '#2563eb', mb: 1 }} />
          <Typography
            variant="h3"
            sx={{
              fontWeight: 900,
          ...
          >
            Free Clinics & Shelters For Injured Wildlife
          </Typography>
          <Typography
            variant="h6"
          ...
          >
            Access trusted, compassionate medical clinics for all your health needs.
          </Typography>
        </Box>
        ...
        {loading ? (
          ...
          <Grid container spacing={5}>
            {clinics.map((clinic, idx) => (
              <Grid item xs={12} md={6} lg={4} key={clinic._id}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', mb: 1.2 }}>
                        <LocationOn sx={{ color: '#f472b6', mr: 1, fontSize: 20 }} />
                      ...
                      {clinic.tags && Array.isArray(clinic.tags) && (
...
export default MedicalClinicsPage;