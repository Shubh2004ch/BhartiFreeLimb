  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        >
          <RestaurantMenu sx={{ fontSize: 44, color: 'primary.main', mr: 1 }} />
          <Typography
            variant="h4"
            fontWeight={900}
            sx={{
        ...
        {loading ? (
          ...
          <Grid container spacing={5}>
            {foodStalls.map((stall, idx) => (
              <Grid item key={stall._id} xs={12} sm={6} md={4}>
        ...
        >
          ...
          <DialogContent>
            <form onSubmit={handleSubmit} id="foodstall-form">
              <TextField
                fullWidth
                label="Name"
                value={formData.name}
              ...
              <Box sx={{ mt: 2 }}>
                ...
                {editingStall && editingStall.imagePath && (
                  <Box mt={2} textAlign="center">
                    <img
                      src={getImageUrl(editingStall.imagePath)}
                      alt={editingStall.name}
                      style={{
                        maxWidth: 120,
                        maxHeight: 120,
                        borderRadius: 12,
...
export default FoodStallManager;