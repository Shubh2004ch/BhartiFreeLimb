...
import { LocationOn, AccessTime, Phone, Directions, Star } from '@mui/icons-material';
  ...
  <Box sx={{ py: 8, bgcolor: 'background.paper' }}>
    <Container maxWidth="lg">
      ...
      <Box sx={{ display: 'flex', gap: 2, overflowX: 'auto', pb: 2 }}>
        {[1, 2, 3].map((item) => (
          <Box key={item} sx={{ minWidth: '280px', flexShrink: 0 }}>
...
// Prosthetic Center Card Component
const ProstheticCenterCard = ({ item, index }) => {
...
// Main Component
const ProstheticCentersSection = () => {
    ...
    >
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 3 }}>
          ...
          >
            Find specialized prosthetic centers offering comprehensive care and support.
          </Typography>
        </Box>
...
export default ProstheticCentersSection; 