  ...
  <Box sx={{ py: 8, bgcolor: 'background.paper' }}>
    <Container maxWidth="lg">
      <Typography variant="h3" component="h2" gutterBottom align="center" sx={{ mb: 6 }}>
        Medical Clinics & Shelters for Injured Wildlife
      </Typography>
    ...
    >
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          >
            <LocalHospital sx={{ fontSize: '2.5rem' }} />
            Medical Clinics & Shelters for Injured Wildlife
          </Typography>
          <Typography
            variant="subtitle1"
          ...
          >
            Find medical clinics providing free healthcare services
          </Typography>
        </Box>
              ...
              <Fade in timeout={500} style={{ transitionDelay: `${index * 100}ms` }}>
                <div>
                  <MainCard
                    ...
                    onClick={() => navigate(`/medical-clinics/${item._id}`)}
